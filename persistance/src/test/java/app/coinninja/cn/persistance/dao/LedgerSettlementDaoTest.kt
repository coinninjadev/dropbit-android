...
class LedgerSettlementDaoTest {
    ...
    fun returns_settlement_containing_invoice_data() {
        ...
        val settlements = db.ledgerSettlementDao.all()
        ...
        assertThat(settlements.get(0).invoiceValue?.toLong()).isEqualTo(invoice1.value.toLong())
        assertThat(settlements.get(0).invoiceNetworkFee?.toLong()).isEqualTo(invoice1.networkFee.toLong())
        assertThat(settlements.get(0).invoiceProcessingFee?.toLong()).isEqualTo(invoice1.processingFee.toLong())
