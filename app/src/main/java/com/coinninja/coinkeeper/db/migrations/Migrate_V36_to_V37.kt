...
class Migrate_V36_to_V37 : AbstractMigration() {
    ...
    override fun applyMigration(db: Database, currentVersion: Int) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `LIGHTNING_ACCOUNT` (`_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `SERVER_ID` TEXT NOT NULL, `ADDRESS` TEXT NOT NULL, `BALANCE` INTEGER NOT NULL, `PENDING_IN` INTEGER NOT NULL, `PENDING_OUT` INTEGER NOT NULL, `CREATED_AT` TEXT NOT NULL, `UPDATED_AT` TEXT NOT NULL)")
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'adeb22107a611fd1498656f1250889a2')")
    }
}
