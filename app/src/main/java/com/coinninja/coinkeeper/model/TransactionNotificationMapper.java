...
public class TransactionNotificationMapper {
    ...
    public TransactionNotificationV1 toV1(TransactionNotification transactionNotification) {
        InfoV1 infoV1 = new InfoV1();
        infoV1.setMemo(transactionNotification.getMemo());
        infoV1.setCurrency(transactionNotification.getAmountCurrency());
        infoV1.setAmount(transactionNotification.getAmount());

        CNPhoneNumber CNPhoneNumber = new CNPhoneNumber(transactionNotification.getPhoneNumber());

        ProfileV1 profileV1 = new ProfileV1();
        profileV1.setAvatar(transactionNotification.getAvatar());
        profileV1.setHandle(transactionNotification.getDropbitMeHandle());
        profileV1.setDisplayName(transactionNotification.getDisplayName());
        ...
        v1.setTxid(transactionNotification.getTxid());
        v1.setInfo(infoV1);
