...
public class PhoneNumber implements Parcelable {
    ...
    public PhoneNumber(String i18n) {
        this._phoneNumber = phoneNumberUtil.toPhoneNumber(i18n);
    }
    ...
    public PhoneNumber(int countryCode, String phoneNumber) {
        this._phoneNumber = phoneNumberUtil.toPhoneNumber(countryCode, phoneNumber);
    }

    public PhoneNumber(CNPhoneNumber phoneNumber) {
        this._phoneNumber = phoneNumberUtil.toPhoneNumber(phoneNumber);
    }
    ...
    public static final Creator<PhoneNumber> CREATOR = new Creator<PhoneNumber>() {
        ...
        public PhoneNumber createFromParcel(Parcel in) {
            ...
            return new PhoneNumber(in.readString());
        }
    ...
    public long getNationalNumber(){
        return _phoneNumber.getNationalNumber();
    }

    @NotNull
    public String toString(){
        return phoneNumberUtil.i18Formatted(this._phoneNumber);
    }
