...
public class TransactionDetailDialogControllerTest {
    ...
    public void closing_dialog_using_ic_close_dismisses_self() {
        ...
        getLastShownAlertDialog().findViewById(R.id.ic_close).performClick();
    ...
    public void renders_fees() {
        ...
        TextView fee = getLastShownAlertDialog().findViewById(R.id.value_network_fee);
    ...
    public void share_txid_with_other_apps() {
        ...
        getLastShownAlertDialog().findViewById(R.id.share_transaction).performClick();
    ...
    public void views_transaction_on_cn_block_explorer() {
        ...
        getLastShownAlertDialog().findViewById(R.id.see_on_block).performClick();
    ...
    public void views_address_on_cn_block_explorer() {
        ...
        getLastShownAlertDialog().findViewById(R.id.receive_address).performClick();
    ...
    public void sets_address_to_be_the_receive_address() {
        ...
        TextView address = getLastShownAlertDialog().findViewById(R.id.receive_address);
    ...
    public void sets_value_of_transaction___as_transfer() {
        ...
        TextView value = getLastShownAlertDialog().findViewById(R.id.value_when_sent);
    ...
    public void sets_number_of_confirmations() {
        ...
        controller.showTransaction(activity, bindableTransaction);
        TextView confirmations = getLastShownAlertDialog().findViewById(R.id.value_confirmations);
        assertThat(confirmations, hasText("6+"));

        when(bindableTransaction.getConfirmationCount()).thenReturn(5);
        controller.showTransaction(activity, bindableTransaction);
        confirmations = getLastShownAlertDialog().findViewById(R.id.value_confirmations);
    ...
    public void sets_confirmation_state() {
        ...
        controller.showTransaction(activity, bindableTransaction);
        TextView confirmations = getLastShownAlertDialog().findViewById(R.id.confirmations);
        assertThat(confirmations, hasText(Resources.INSTANCE.getString(activity, R.string.confirmations_view_stage_5)));

        when(bindableTransaction.getConfirmationState()).thenReturn(BindableTransaction.ConfirmationState.UNCONFIRMED);
        controller.showTransaction(activity, bindableTransaction);
        confirmations = getLastShownAlertDialog().findViewById(R.id.confirmations);
    ...
    public void renders_send_icon_when_transfer() {
        ...
        ImageView imageView = getLastShownAlertDialog().findViewById(R.id.ic_send_state);
