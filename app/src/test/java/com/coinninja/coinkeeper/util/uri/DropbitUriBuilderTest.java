...
public class DropbitUriBuilderTest {
    ...
    public void test_dropbit_transaction_url() {
        assertEquals(builder.build(DROPBIT_TRANSACTION).toString(), "https://dropbit.app/tooltip/dropbittransaction");
    }

    @Test
    public void test_regular_transaction_url() {
        assertEquals(builder.build(REGULAR_TRANSACTION).toString(), "https://dropbit.app/tooltip/regulartransaction");
    }

    @Test
    public void test_transaction_details_url() {
        assertEquals(builder.build(TRANSACTION_DETAILS).toString(), "https://dropbit.app/tooltip/transactiondetails");
    }
