...
class LedgerInvoiceTest {
    ...
    fun converts_to_db_model() {
        ...
        val invoice = ledgerResponse.invoices[0].toLightningLedger()

        assertThat(invoice.serverId).isEqualTo("3228fe64710af215840ec2fa96a0cbde4ca9dd15e6931743fe68d0259cba432d:0")
